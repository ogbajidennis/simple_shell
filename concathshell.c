...
/**
 * append_command - Concatenanates string with paths in global PATH variable
 * @dir_path: location of string to be appended with command
 * @command: command to be concatenated with dir_path
